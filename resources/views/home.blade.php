...
<section class="border-t border-archive-border px-4 py-12 md:px-8 md:py-20">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="grid grid-cols-2 gap-3 gap-y-4 sm:gap-4 md:grid-cols-4 md:gap-6">
...
<section class="border-t border-archive-border px-4 py-12 md:px-8 md:py-20">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="grid grid-cols-3 gap-x-2 gap-y-4 max-md:grid-cols-3 md:grid-cols-4 md:gap-6 md:gap-y-8">
...
<section class="border-t border-archive-border px-4 py-12 md:px-8 md:py-20">
    <div class="mx-auto max-w-7xl">
        ...
        <div class="grid grid-cols-5 gap-x-1.5 gap-y-4 max-md:grid-cols-5 md:grid-cols-4 md:gap-6 md:gap-y-8">
